 ...
 * Inspired in layout by film.gov.ae/locations. Imagery is real, freely-licensed
 * Abu Dhabi landmark photography sourced from Wikimedia Commons (see
 * /public/images/locations/SOURCES.json for attribution/licenses); responsive
 * WebP variants are generated by the asset pipeline. Two categories:
 * "Modern Architecture" and "Villas". Photos stand in as location placeholders —
...
const locationItems = [
  {
    ...
    gallery: [
      { src: locImg.skyline, span: 'span-4', tall: true, alt: 'Abu Dhabi Corniche skyline of glass towers across the water.' },
      { src: locImg.etihad, span: 'span-2', alt: 'The curved glass Etihad Towers on the Abu Dhabi Corniche.' },
      { src: locImg.capital, span: 'span-2', alt: 'Capital Gate, Abu Dhabi’s dramatic leaning tower.' },
      { src: locImg.almaryah, span: 'span-2', alt: 'High-rise towers on Al Maryah Island, Abu Dhabi.' },
      { src: locImg.palace, span: 'span-2', alt: 'Emirates Palace and the Abu Dhabi waterfront.' },
    ],
  },
  {
    ...
    gallery: [
      ...
      { src: locImg.yasIsland, span: 'span-3', alt: 'Aerial of Yas Island with its marina and circuit, Abu Dhabi.' },
      { src: locImg.skyline, span: 'span-2', alt: 'Abu Dhabi skyline across the water at golden hour.' },
      { src: locImg.etihad, span: 'span-2', alt: 'Curved glass towers reflecting the sky, Abu Dhabi.' },
      { src: locImg.almaryah, span: 'span-2', alt: 'Modern waterfront high-rises, Abu Dhabi.' },
    ],
  },
  {
    slug: 'cultural-hall',
    ...
    gallery: [
      { src: locImg.louvre, span: 'span-4', tall: true, alt: 'The latticed dome of Louvre Abu Dhabi rising over the water.' },
      { src: locImg.mosque, span: 'span-2', alt: 'White domes and arches of the Sheikh Zayed Grand Mosque.' },
      { src: locImg.palace, span: 'span-2', alt: 'The grand facade of Emirates Palace, Abu Dhabi.' },
      { src: locImg.etihad, span: 'span-2', alt: 'Etihad Towers glass facades, Abu Dhabi.' },
      { src: locImg.capital, span: 'span-2', alt: 'Capital Gate’s leaning architectural form, Abu Dhabi.' },
    ],
  },
  {
    ...
    gallery: [
      ...
      { src: locImg.palace, span: 'span-3', alt: 'Beachfront grounds of Emirates Palace, Abu Dhabi.' },
      { src: locImg.louvre, span: 'span-2', alt: 'Waterside architecture of Louvre Abu Dhabi.' },
      { src: locImg.skyline, span: 'span-2', alt: 'Abu Dhabi coastline and skyline across the Gulf.' },
      { src: locImg.mosque, span: 'span-2', alt: 'Sunlit white marble of the Sheikh Zayed Grand Mosque.' },
    ],
  },
  {
    ...
    gallery: [
      { src: locImg.almaryah, span: 'span-4', tall: true, alt: 'City view from Al Maryah Island, Abu Dhabi’s financial district.' },
      { src: locImg.skyline, span: 'span-2', alt: 'Abu Dhabi high-rise skyline across the water.' },
      { src: locImg.etihad, span: 'span-2', alt: 'The Etihad Towers, Abu Dhabi.' },
      { src: locImg.yasHotel, span: 'span-2', alt: 'Illuminated modern architecture at night, Abu Dhabi.' },
      { src: locImg.palace, span: 'span-2', alt: 'Emirates Palace grand exterior, Abu Dhabi.' },
    ],
  },
  {
    ...
    gallery: [
      ...
      { src: locImg.palace, span: 'span-3', alt: 'Palatial Arabian architecture against the Abu Dhabi sky.' },
      { src: locImg.saadiyat, span: 'span-2', alt: 'Coastal dunes and turquoise shallows near Abu Dhabi.' },
      { src: locImg.mosque, span: 'span-2', alt: 'White domes of the Sheikh Zayed Grand Mosque.' },
      { src: locImg.skyline, span: 'span-2', alt: 'Abu Dhabi skyline on the horizon.' },
    ],
  },
];
